...
class Informatico(Persona):
    ...
    def __init__(self, nombres, apellidos, altura, edad, titulo, años_estudio, certicado, universidad, otros, experiencia, lenguajes):
        # LLama al constructor para establecer los valores iniciales
        super().__init__(nombres, apellidos, altura, edad)
        self.titulo = titulo 
